...
public class Humk extends Fragment implements ViewPager.OnPageChangeListener,TabHost.OnTabChangeListener{
    ...
    private void inittabHost() {
        ...
        tabhost.setup();
        String[] tabnames={"Home Science","Political science","English","History","Geographic",};
