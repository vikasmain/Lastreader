...
import com.example.dell.reader.fgrt;
import com.example.dell.reader.fgrt2;
import com.example.dell.reader.fgrt3;
...
public class classten extends Fragment implements ViewPager.OnPageChangeListener,TabHost.OnTabChangeListener{
    ...
    private void inittabHost() {
        ...
        tabhost.setup();
        String[] tabnames={"Physics","Chemistry","Mathematics","Accounts","Economics","English"};
    ...
    private void initviewpager() {
        ...
        listfragments.add(new fgrt3());
        listfragments.add(new fgrt());
        listfragments.add(new fgrt2());
